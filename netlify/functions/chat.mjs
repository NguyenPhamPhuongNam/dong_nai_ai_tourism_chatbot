...
export const handler = async (event) => {
  ...
  try{const ai=new GoogleGenAI({apiKey}); const response=await ai.models.generateContent({model: "gemini-2.5-flash-lite", contents:prompt}); return jsonResponse(200,{reply:response.text||'Xin lỗi, tôi chưa tạo được câu trả lời.'})}
